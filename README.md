...
To solve this level we need to call the enter function and pass the conditions of each function modifier. To pass:<br/>
     - gateOne: we will create a malicious contract with a function letMeIn that calls the enter function of the 
                        ...
                        level 4 Telephone for more details).<br/>
     - gateTwo: to see the remaining gas we can use the functionality of Remix-IDE. The value we are looking for will be 
                        ...
                        malicious contract and brute-force a range of possible gas values. To account for it, we will increase the gas limit in Remix-IDE.<br/>
